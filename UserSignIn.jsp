...
<body>
	<div class="body_wrapper">
		<div class="center">
			...
			if(request.getParameter("notmatch")!=null)
			{
				out.print("<script>alert('OTP Not Match..! Please try Again..!')</script>");
			}
			if(request.getParameter("otp")!=null)
			{
				out.print("<script>alert('OTP Match Successfully..!')</script>");
			}
					...
					<div class="col-sm-12 col-md-12 col-lg-12">
						<div
							...
							<form action="SignInServlet" method="post" name="ureg">
								<div class="pageform">
									<label
										style="color: #0084b4; text-align: center; margin-bottom: 7%">User Login</label><br>
										<label>Mobile Number</label><br> <input type="text" name="mobile"
